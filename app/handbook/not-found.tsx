...
export default function HandbookNotFound() {
  return (
    <main className="flex flex-1 flex-col items-center justify-center gap-6 pt-nav">
      <p className="font-mono text-[0.72rem] tracking-[0.1em] uppercase text-muted-foreground">
      ...
      <Link
        href="/handbook"
        className="inline-flex items-center bg-primary px-7 py-3 text-[0.8rem] font-semibold uppercase tracking-[0.06em] text-primary-foreground transition-opacity hover:opacity-90"
      >
